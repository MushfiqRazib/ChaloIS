...
namespace HIT.OB.STD.Wrapper.DAL
{
    public class ConfigManager
    {
        ...
        public static string GetAccessTimeout()
        {
            return ConfigurationManager.AppSettings["accesstimeout"];
        }
        ...
        public static string GetDefaultConnectionKit()
        {
            return ConfigurationManager.AppSettings["defaultconnectionkit"];
        }
        public static string GetDefaultDocSharedPathforkit()
        {
            return ConfigurationManager.AppSettings["defaultdocSharedPathforkit"];
        }
    }
}
