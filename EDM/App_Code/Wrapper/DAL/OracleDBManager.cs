...
{
    public class OracleDBManager : IWrapFunctions
    {
        ...
        public static void ExecuteTransaction(OleDbCommand[] commands)
        {
            OleDbTransaction transaction = null;
            OleDbConnection conn;
            conn = new OleDbConnection(OracleDBManager.ConnectionString);
        ...
        public bool InsertGroupColor(string REPORT_CODE, string GROUP_BY, string GROUP_CODE, string COLOR_CODE)
        {
            ...
            try
            {
                ...
                commands = new OleDbCommand(deleteSQL, conn);
                ...
                for (int i = 0; i < groupList.Length; i++)
                {
                    ...
                    commands = new OleDbCommand(insertSQL, conn);
        ...
        public string GetArticleCodeAndRevisionAndOmschrijvingAndPartlistDescriptionAndDataQuery(string sqlFrom, string whereClause, string rep_code)
        {
            throw new Exception("Not implemented for this database !");
        }
