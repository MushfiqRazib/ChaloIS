...
namespace HIT.OB.STD.Core.DAL
{
    public interface IOBFunctions
    {
        ...
        string GetRelativeFileName(string tableName, string keyList, string valueList);
        ArrayList GetFieldValues(string SQL_FROM, string FIELD_NAME);
        string CheckCustomFieldValidation(string REPORT_CODE, string SQL_FROM, string customFields,string groupBy);
        ...
        string GetTasksOriginalFileName(string task_id);
