...
function ProcessSULFile(SULFilePath, itemCode, itemRev, gDBConn)
	...
	Do Until objFile.AtEndOfStream
		...
		if i > 13 and trim(lineString) <> "" then
			If trim(lineString) <> "" and Instr(lineString,"KABI-AUSWERTUNG") < 1 and Instr(lineString,"Zeichnung") < 1 and Instr(lineString,"Zust.") < 1 _
			 and Instr(lineString,"STUECKLISTE") < 1 and Instr(lineString,"Aend.-Nr.:") < 1  and Instr(lineString,"Sachnummer") < 1 _
			 and trim(lineString) <> "--------------  ----------------------------------------------   -------------" _
			 and Len(trim(lineString)) > 2 _
			 and trim(lineString) <> "----------  -------------  ----------------------------------------  --  -----" Then
