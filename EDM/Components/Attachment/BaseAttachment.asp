...
Dim ArtikelNr, docPath,version,sqlFrom, RCorVA, DOC_DIR,mcodeField, revField, topMsg, relativePath,relPathParts
 ...
 relativePath = GetFileRelativePathForBaseMaterial(mcodeField, ArtikelNr, sqlFrom)
                                        ...
                                        <table >                                           
                                            <tr>                                            
                                                <td style="height: 100%; margin: 5px 10px 5px 10px;" colspan="5">
                                                    <div id="GridBase" class="Datagrid" style="overflow:auto;height:500px; width: 600px;">
                                                        <%= CreateBaseMaterialDataGrid(docPath,"GridBaseMaterial",ArtikelNr)%>                                                        
                                                    </div>
                                                </td>
                                            </tr>                                            
                                        </table>
