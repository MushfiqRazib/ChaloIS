...
If oForm.Submitted Then
  ...
  If (oFile.FileSize > 0) Then
    ...
    IF version="" Then
     fileName = ArtikelNr & "_" & itemDescr & "." & oFile.FileExt
    Else
    
    fileName = ArtikelNr & "_" & version & "_" & itemDescr & "." & oFile.FileExt
...
<body class="BodyStyle">
    <form name="ItemForm" action="./AddAttachment.asp" enctype="multipart/form-data"
    method="POST">
